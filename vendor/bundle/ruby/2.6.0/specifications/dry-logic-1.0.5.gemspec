...
Gem::Specification.new do |s|
  ...
  s.metadata = { "changelog_uri" => "https://github.com/dry-rb/dry-logic/blob/master/CHANGELOG.md", "source_code_uri" => "https://github.com/dry-rb/dry-logic" } if s.respond_to? :metadata=
